...
<meta name="description" content="One platform. All your health savings needs. Trusted by individuals, families, and organisations across Nigeria.">
...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,400&display=swap" rel="stylesheet">
...
<div class="strip">
  <div class="strip-track">
    <div class="si">Health Savings Wallet</div><div class="si">Telemedicine ₦3,500</div>
    <div class="si">Free Drug Delivery</div><div class="si">Non-interest Returns</div>
    <div class="si">No Waiting Period</div><div class="si">100+ Providers</div>
    <div class="si">Organisation Plans</div><div class="si">Family Coverage</div>
    <div class="si">Health Savings Wallet</div><div class="si">Telemedicine ₦3,500</div>
    <div class="si">Free Drug Delivery</div><div class="si">Non-interest Returns</div>
    <div class="si">No Waiting Period</div><div class="si">100+ Providers</div>
    <div class="si">Organisation Plans</div><div class="si">Family Coverage</div>
...
<div class="hero-left">
  <div class="hero-content rv">
    <h1><span class="h1-dark">Save for your health.</span><br><em class="h1-shine">Before you need it.</em></h1>
    <p class="hero-sub">One platform. All your health savings needs. Trusted by individuals, families, and organisations across Nigeria.</p>
    <div class="hero-btns">
      <a href="maintenance.html" class="btn-p">Open an Account <svg width="13" height="13" viewBox="0 0 14 14" fill="none"><path d="M1 7h12M7 1l6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
      <a href="#services" class="btn-o">Our Services</a>
    </div>
    <div class="hero-stats">
      <div class="hs"><div class="hs-v"><span>₦50k</span></div><div class="hs-l">Individual minimum</div></div>
      <div class="hs"><div class="hs-v"><span>₦3,500</span></div><div class="hs-l">Telemedicine fee</div></div>
      <div class="hs"><div class="hs-v"><span>0%</span></div><div class="hs-l">Riba</div></div>
    </div>
  </div>
</div>
...
<div class="hero-right">
  <svg style="position:absolute;inset:0;width:100%;height:100%;pointer-events:none" viewBox="0 0 600 700" preserveAspectRatio="xMidYMid slice">
    <defs>
  ...
  <svg viewBox="0 0 600 680" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- PLATFORM -->
    <polygon points="300,390 460,480 300,570 140,480" fill="url(#platTop)" stroke="#b8dce6" stroke-width="1"/>
...
<g style="animation:bar1 1s cubic-bezier(.34,1.56,.64,1) forwards 0.8s;transform:scaleY(0);transform-origin:300px 465px">
  <!-- Bar top face -->
  ...
  <!-- Naira on bar -->
  <text x="230" y="415" font-family="Inter,sans-serif" font-size="11" font-weight="700" fill="#020C12" text-anchor="middle" opacity=".8">₦</text>
</g>

<!-- Bar 2 — medium, vivid coral -->
<g style="animation:bar1 1s cubic-bezier(.34,1.56,.64,1) forwards 1.1s;transform:scaleY(0);transform-origin:300px 465px">
  ...
  <text x="280" y="365" font-family="Inter,sans-serif" font-size="11" font-weight="700" fill="white" text-anchor="middle" opacity=".9">₦</text>
</g>

<!-- Bar 3 — tall, electric gold -->
<g style="animation:bar1 1s cubic-bezier(.34,1.56,.64,1) forwards 1.4s;transform:scaleY(0);transform-origin:300px 465px">
  ...
  <text x="330" y="305" font-family="Inter,sans-serif" font-size="11" font-weight="700" fill="#020C12" text-anchor="middle" opacity=".9">₦</text>
</g>

<!-- Bar 4 — tallest, vivid lime green growth -->
<g style="animation:bar1 1s cubic-bezier(.34,1.56,.64,1) forwards 1.7s;transform:scaleY(0);transform-origin:300px 465px">
  ...
  <text x="380" y="234" font-family="Inter,sans-serif" font-size="14" font-weight="900" fill="#020C12" text-anchor="middle" opacity=".95">₦</text>
</g>

<!-- Trend arrow rising above tallest bar -->
<g style="animation:fade-in-up 1s ease forwards 2.4s;opacity:0" filter="url(#glow2)">
  <polyline points="195,435 245,385 295,328 345,265 385,210"
    stroke="#00E5FF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <!-- Arrow tip -->
  <path d="M385 210 L400 190 M400 190 L390 190 M400 190 L400 200"
    stroke="#00E5FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</g>

<!-- Percentage growth label floating above -->
<g style="animation:float-up 3s ease-in-out infinite 2s;opacity:0;animation-fill-mode:forwards" filter="url(#cardShadow)">
  <rect x="330" y="155" width="100" height="44" rx="12" fill="#020C12" stroke="#00E5FF" stroke-width="1.5"/>
  <text x="380" y="174" font-family="Inter,sans-serif" font-size="9" font-weight="600" fill="#00C8E8" text-anchor="middle" letter-spacing=".08em">GROWTH</text>
  <text x="380" y="192" font-family="Inter,sans-serif" font-size="16" font-weight="900" fill="#69FF9A" text-anchor="middle">+28%</text>
</g>

<!-- Rising coins above bars -->
<text style="animation:naira-drift 3s ease-in-out infinite" x="170" y="360" font-family="Inter,sans-serif" font-size="16" font-weight="700" fill="#00E5FF" opacity=".6" filter="url(#glow2)">₦</text>
<text style="animation:naira-drift 4s ease-in-out infinite 1s" x="220" y="300" font-family="Inter,sans-serif" font-size="12" font-weight="700" fill="#FFB300" opacity=".55" filter="url(#glow2)">₦</text>
<text style="animation:naira-drift 3.5s ease-in-out infinite 0.5s" x="440" y="330" font-family="Inter,sans-serif" font-size="14" font-weight="700" fill="#69FF9A" opacity=".5" filter="url(#glow2)">₦</text>
<text style="animation:naira-drift 5s ease-in-out infinite 2s" x="130" y="280" font-family="Inter,sans-serif" font-size="10" font-weight="600" fill="#FF6B2B" opacity=".45">₦</text>
    ...
    <!-- FLOATING NAIRA -->
    <text style="animation:naira-drift 5s ease-in-out infinite" x="488" y="340" font-family="Inter,sans-serif" font-size="18" font-weight="700" fill="#459DAF" opacity=".35" filter="url(#glow2)">₦</text>
    <text style="animation:naira-drift 6s ease-in-out infinite 1.5s" x="58" y="430" font-family="Inter,sans-serif" font-size="14" font-weight="600" fill="#00B4D0" opacity=".3">₦</text>

    <!-- HEARTBEAT -->
    <polyline class="art-heartbeat" points="60,635 90,635 106,608 124,668 140,618 156,635 194,635 206,626 218,635 260,635" stroke="#459DAF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none" filter="url(#glow2)" opacity=".7"/>
...
<section class="statement" id="statement">
  <div class="st-inner">
    ...
    <div class="st-left">
      ...
      <p class="st-sub">Nigeria is in the middle of a quiet health crisis — many undiagnosed, none financially prepared. Span exists to change that.</p>
    </div>
    ...
    <div class="st-right">
      ...
      <div class="st-stats">
        <div class="st-stat"><div class="st-sv">8M+</div><div class="st-sl">Diabetics</div></div>
        <div class="st-stat"><div class="st-sv">1 in 4</div><div class="st-sl">Hypertensive</div></div>
        <div class="st-stat"><div class="st-sv">₦480k</div><div class="st-sl">Avg crisis cost</div></div>
      </div>
    </div>
...
<section class="split" id="services">
  <div class="split-inner rv">
    <div class="art-tile at1">
      <img src="img/Pic1.jpg" alt="Health savings member" style="width:100%;height:100%;object-fit:cover;display:block;position:absolute;inset:0">
      <div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(3,14,20,.7) 0%,transparent 60%)"></div>
      <div class="tile-card">
        <div><div class="tc-v">₦50,000</div><div class="tc-l">Individual minimum</div></div>
    ...
    <div class="split-content">
      ...
      <p class="sec-p">A dedicated account for your healthcare costs. Your balance is always accessible for consultations, hospital visits, and medications — and earns non-interest returns while it waits.</p>
      <ul class="check-list">
...
<section class="split alt">
  <div class="split-inner rev rv">
    <div class="art-tile at2">
      <img src="img/Pic2.jpg" alt="Telemedicine consultation" style="width:100%;height:100%;object-fit:cover;display:block;position:absolute;inset:0">
      <div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(3,14,20,.7) 0%,transparent 60%)"></div>
      <div class="tile-card">
        <div><div class="tc-v">₦3,500</div><div class="tc-l">Flat rate · Free drug delivery</div></div>
    ...
    <div class="split-content">
      ...
      <p class="sec-p">Consult a verified Nigerian doctor via video, audio, or chat — any time, any day. Receive prescriptions instantly. Medications delivered free to your door, billed from your wallet.</p>
      <ul class="check-list">
...
<section class="split">
  <div class="split-inner rv">
    <div class="art-tile at3">
      <img src="img/Pic3.jpg" alt="Family coverage" style="width:100%;height:100%;object-fit:cover;display:block;position:absolute;inset:0">
      <div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(3,14,20,.7) 0%,transparent 60%)"></div>
      <div class="tile-card">
        <div><div class="tc-v">₦100,000</div><div class="tc-l">Family or organisation minimum</div></div>
    ...
    <div class="split-content">
      ...
      <p class="sec-p">One account covers your entire household — spouse, children, and parents. Schools, SMEs, and agencies can enroll staff on tailored group plans that give real healthcare access to every team member.</p>
      <ul class="check-list">
...
<section class="disease" id="why">
  ...
  <svg class="disease-art" viewBox="0 0 1200 500" fill="none" preserveAspectRatio="xMidYMid slice">
    <polyline points="50,450 150,380 250,320 350,260 450,210 600,160 750,130 900,100 1050,75 1200,50" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" opacity=".6"/>
  ...
  <div class="d-grid">
    <div class="d-card rv">
      <div class="d-ico"><svg width="22" height="22" viewBox="0 0 20 20" fill="none" stroke="#00B4D0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10L10 4a4.24 4.24 0 016 6l-6 6a4.24 4.24 0 01-6-6z"/></svg></div>
      <div class="d-num">8 Million</div>
      <div class="d-title">Nigerians Living With Diabetes</div>
      <p class="d-text">Nearly 3 in 4 are undiagnosed. Managing diabetes costs ₦80,000–₦200,000 per year — every year, for life.</p>
    </div>
    <div class="d-card rv d1">
      <div class="d-ico"><svg width="22" height="22" viewBox="0 0 20 20" fill="none" stroke="#00B4D0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 17S2 12 2 7a4 4 0 017-2.65A4 4 0 0118 7c0 5-8 10-8 10z"/></svg></div>
      <div class="d-num">1 in 4</div>
      <div class="d-title">Nigerian Adults Have Hypertension</div>
      <p class="d-text">Silent. Lifelong medication required. Untreated it leads to stroke, heart failure, kidney damage — the most expensive outcomes in healthcare.</p>
    </div>
    <div class="d-card rv d2">
      <div class="d-ico"><svg width="22" height="22" viewBox="0 0 20 20" fill="none" stroke="#00B4D0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 2L3 5v5c0 4.5 3 8 7 9 4-1 7-4.5 7-9V5l-7-3z"/></svg></div>
      <div class="d-num">₦480,000</div>
      <div class="d-title">Average Catastrophic Health Event</div>
      <p class="d-text">A single hospitalisation can cost ₦300,000–₦2,000,000 out of pocket. Most Nigerian families are one illness from a financial crisis.</p>
    </div>
  </div>
</section>
  ...
  <div class="ph-grid">
    ...
    <div class="ph-card">
      ...
      <div class="ph-body">
        ...
        <p class="ph-p">A savings account built exclusively for healthcare. Always accessible. Earns non-interest returns while it waits.</p>
        <div class="ph-stat">
    ...
    <div class="ph-card ph-dark">
      ...
      <div class="ph-body">
        ...
        <p class="ph-p">Consult verified Nigerian doctors anytime. Prescriptions instantly. Medications delivered free.</p>
        <div class="ph-stat">
    ...
    <div class="ph-card">
      ...
      <div class="ph-body">
        ...
        <p class="ph-p">One account. Spouse, children, parents. Schools, SMEs, and agencies with tailored group plans.</p>
        <div class="ph-stat">
...
<section class="clarity" id="whyspan">
  <div class="clarity-inner rv">
    ...
    <div class="clarity-content">
      ...
      <h2 class="clarity-h">Span offers a designated Health Savings Account built for individuals and families.<br><em>Something better.</em></h2>
      ...
      <div class="clarity-notes">
        <div class="clarity-note">
          <div class="cn-ico">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2DB8D4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div>
            ...
            <div class="cn-text">No waiting periods. No approval queues. Deposit and your wallet is live immediately — pre-existing conditions covered.</div>
          </div>
        </div>
        <div class="clarity-note">
          <div class="cn-ico">
          ...
          <div>
            ...
            <div class="cn-text">No claims, no rejections. Pay directly from your wallet at any partner provider with no forms.</div>
          </div>
        </div>
        <div class="clarity-note">
          <div class="cn-ico">
      ...
      <a href="maintenance.html" class="btn-p" style="width:fit-content;display:inline-flex;margin-top:1.5rem">Open an Account →</a>
    </div>
...
<section class="testi" id="testimonials">
  ...
  <div class="tg rv d1">
    <div class="tc">
      <div class="tc-q">"</div>
      <p class="tc-text">My father has hypertension. With Span we consult a doctor from home, get his medications delivered free, and his hospital visits are billed straight from the wallet. No forms. No waiting.</p>
      <div class="tc-name">Chioma O.</div><div class="tc-role">Lagos — Social Media Manager</div>
    </div>
    <div class="tc">
      <div class="tc-q">"</div>
      <p class="tc-text">I switched from health insurance that kept rejecting my claims. With Span, my balance is mine. I use it when I need it. No approvals, no rejections.</p>
      <div class="tc-name">Tunde A.</div><div class="tc-role">Abuja — IT Professional</div>
    </div>
    <div class="tc">
      <div class="tc-q">"</div>
      <p class="tc-text">We enrolled our school staff on Span. Costs dropped and for the first time our teachers feel genuinely looked after. The telemedicine alone saved us hours of lost working time.</p>
      <div class="tc-name">Bello K.</div><div class="tc-role">Kano — School Administrator</div>
    </div>
  </div>
</section>
...
<section class="cta" id="cta">
  <div class="cta-inner">
    ...
    <div class="cta-right">
      ...
      <p class="cta-sub">The only Sharia-compliant health savings platform in Nigeria. Open your account in minutes.</p>
